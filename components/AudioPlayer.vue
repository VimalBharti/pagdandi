      ...
      <tbody>
        ...
        <tr>
          <td>
            ...
            <button type="button" @click="SpeechForm.zoomin()" class="btn btn-default"><i class="glyphicon glyphicon-zoom-in"></i> Zoom in</button>
            <button type="button" @click="SpeechForm.zoomout()" class="btn btn-default"><i class="glyphicon glyphicon-zoom-out"></i> Zoom out</button>
